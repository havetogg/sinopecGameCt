...
<body>
	...
	<div>
	 ...
	 <div>
            ...
            <label for="IMAGE_UPLOAD"><img id="uploadImg" src="${contentPath }/img/h_ticket_add.png"  style="width: 290px;height: 62px;" alt=""></label>
...
/* 				if($.trim(LINK_URL).length==0){
				...
				if(confirm('确实要提交吗？')){
					$.ajax({
						type : 'post',
						url : 'save.htm',
						data:{'NAME':NAME,'BANNER_TYPE':BANNER_TYPE,'IMAGE_URL':IMAGE_URL,'LINK_URL':LINK_URL,'IN_USE_FLAG':IN_USE_FLAG,'SHOW_ORDER':SHOW_ORDER},
						dataType : 'json',
