...
<head>
    ...
    <script type="text/javascript" src="${contentPath }/jsp/weixinMng/mallMng/js/share.js"></script>
		<title>加油达人-新手模式</title>
<script type="text/javascript">
	var needRefresh = sessionStorage.getItem("need-refresh-game2");
	if(needRefresh){
		//如果页面是刷新过来的,就强制返回首页
		window.location=getRootPath() + "/weixinMng/GameOneC/gameOneIn.htm";
	}

	var GAME2KNOWFLAG ='${GAMEONEBEAN.GAME2KNOWFLAG}';

//	$(function (){
//
//		//用户进入引导界面，'我知道了'.用户主动触发事件播放music
//		$("#IKnow_tip").click(function (){
//			media = document.getElementById("audio");
//			media.src = getRootPath()+"/jsp/weixinMng/gameOne/css/music.mp3";
//			media.play();
//		})
//
//	})
			...
			<div class="game">
				...
				<div class="pop Countdown">
					...
					<div class="introduce">
						...
						<div class="tip">
							...
							<p>2.手残模式中，加油过程<span>无需进行加油设置，直接开始加油。</span></p>
							<p>3.待加油车辆将在车位排队，如果造成加油站拥堵，游戏也就结束啦！</p>
						</div>
						<img class="img1" src="${contentPath }/jsp/weixinMng/gameOne/img/introduce3.png" />
				...
				<div class="pop buyTank">
					<div class="centerDiv">
						...
						<p>Tip: 本局收益将在游戏结束后结算</p>
						<div class="img" id="oilimgId">92#</div>
						<a class="buy" href="javascript:;">
							<img src="${contentPath }/jsp/weixinMng/gameOne/img/gold2.png"/>
							<span>1000</span>
						</a>
...
<script type="text/javascript" src="${contentPath }/jsp/weixinMng/gameOne/js/game2.js" ></script>
</html>
