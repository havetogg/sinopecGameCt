...
<head>
	...
	<script type="text/javascript" src="${contentPath }/jsp/backMng/NewsCoverimageMng/NewsCoverimageMng_list.js"></script>
...
<body>
	...
	<input type="hidden" name="NEWS_ID" id="NEWS_ID"  value="${param.NEWS_ID }">
					...
					<tbody>
						<c:forEach items="${list }" var="obj" varStatus="status">
							<tr>
								...
								<td>${obj.NEWS_ID}</td>
								<td onclick="showPic('${obj.CUTTED_PATH}')">${obj.CUTTED_PATH}</td>
