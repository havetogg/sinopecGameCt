...
<head>
	...
	<script type="text/javascript" src="${contentPath }/jsp/backMng/NewsComment/NewsComment_list.js"></script>
	<script type="text/javascript" src="${contentPath }/js/visitStat.js"></script>
</head>
<body>
	<form action="list.htm" method="post" id="pageForm">
	<input name="NEWS_ID" value="${queryParam.NEWS_ID }" type="hidden">
...
<%-- 								<td>${obj.AUDIT_FLAG}</td>
								...
								<td>
									...
									<input name="list_deleteBtn" class="spd_btn1_s" objId="${obj.ID }" NEWS_ID="${param.NEWS_ID }" type="button" value="删除">
								</td>
							</tr>
						</c:forEach>
					</tbody>
