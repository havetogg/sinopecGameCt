$(function(){
	...
	$("input[type='button'][name='news_photos']").click(function(){
		var objId=$(this).attr("objId");
		window.location=getRootPath()+'/backMng/NewsCoverimageMng/list.htm?NEWS_ID='+objId;
		
	});
	
	$("input[type='button'][name='news_comment']").click(function(){
		var objId=$(this).attr("objId");
		window.location=getRootPath()+'/backMng/NewsComment/list.htm?NEWS_ID='+objId;
