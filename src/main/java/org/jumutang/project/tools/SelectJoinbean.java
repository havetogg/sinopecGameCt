...
public class SelectJoinbean {
	...
	private static void selectLeftJoin() {
		String t1="SELECT ID, OPEN_ID, NICK_NAME, HEAD_IMG, MOBILE, NAME, CREAT_TIME, USED_DIAMOND, ALL_DIAMOND, USED_GOLD, ALL_GOLD, USER_RANK_ID, USER_MAX_RANK_ID, THIRD_PART_ID, DELETE_FLAG FROM t_mall_user";
		String t2="SELECT ID, RANK_NAME, RETURN_DIAMOND, RETURN_GOLD, CREAT_TIME, DELETE_FLAG FROM t_rank";
		String t3="SELECT ID, OPEN_ID, NICK_NAME, HEAD_IMG, MOBILE, NAME, CREAT_TIME, USED_DIAMOND, ALL_DIAMOND, USED_GOLD, ALL_GOLD, USER_RANK_ID, USER_MAX_RANK_ID, THIRD_PART_ID, DELETE_FLAG FROM t_mall_user";
